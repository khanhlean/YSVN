...
export default function DinhGia(props: Props) {
    ...
    return (
        ...
        //             <div className="text-[#A5ACBC] font-bold mt-4">ĐỊNH GIÁ (QUÝ)</div>
        //         </div>

        //         <div style={{ width: '100%', height: '85%' }}>
        //             <ResponsiveContainer>
        //                 <ComposedChart
        //                     data={chartData.dinhGia?.slice()}
        //                     margin={{
        //                         top: 40,
        //                         right: 20,
        //                         bottom: 20,
